...
def get_parser():
    ...
    parser.add_argument(
        '--input-type', default='keypoint', help='can be keypoint, test and bone')
    ...
    # feeder
    parser.add_argument(
        '--feeder', default='dataloader_video.BaseFeeder', help='Dataprocessing loader will be used')
    parser.add_argument(
        '--dataset',
        default=None,
        help='Dataprocessing loader will be used'
    )
    parser.add_argument(
        '--dataset-info',
        default=dict(),
    ...
    parser.add_argument(
        ...
        type=int,
        default=4,
        help='the number of worker for Dataprocessing loader')
    parser.add_argument(
        '--feeder-args',
        default=dict(),
