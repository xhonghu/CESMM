...
x = torch.rand(49, 4, 1024)
lgt = torch.tensor([49, 31, 17, 16])
temporal_model = BiLSTMLayer(rnn_type='LSTM', input_size=1024, hidden_size=1024,
                                    num_layers=2, bidirectional=True)
test_output = temporal_model(x,lgt)